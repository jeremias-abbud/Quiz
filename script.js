...
function checkAnswer(e) {
    ...
    if (e.target.innerText === questions[currentQuestion].answer) {
        ...
        alert(`Errado! A resposta é ${questions[currentQuestion].answer}`);
    }
}
...
nextButton.addEventListener("click", () => {
    ...
    if (currentQuestion < questions.length) {
        ...
        if (score > wrong) {
            alert(`Parabéns! Você acertou ${score} de ${questions.length} perguntas.`);
        } else {
            alert(`Tente de novo! Você acertou ${score} de ${questions.length} perguntas.`)
        }
        resetQuiz();
    }
